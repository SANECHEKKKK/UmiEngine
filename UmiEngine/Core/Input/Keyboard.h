...
namespace Umi
{
	...
	{
	private:
		Keyboard_State gState = {};
		Keyboard_State gOldState = {};
	public:
		void Update();
		...
		bool IsKeyDown(Keyboard_Keys key);
		bool IsKeyUp(Keyboard_Keys key);
		bool IsKeyTrigger(Keyboard_Keys key);
		bool IsKeyTrigger(Keyboard_Keys key, const Keyboard_State* pState, const Keyboard_State* pOldState);

		const Keyboard_State* Keyboard_GetState();

		bool IsKeyDown(Keyboard_Keys key, const Keyboard_State* pState);
		bool IsKeyUp(Keyboard_Keys key, const Keyboard_State* pState);
