...
export namespace Umi
{
	...
	private:
		...
		inline static Keyboard_State gOldState;
	public:
		void Update();
		...
		static bool IsKeyDown(Keyboard_Keys key);
		static bool IsKeyUp(Keyboard_Keys key);
		static bool IsKeyTrigger(Keyboard_Keys key);
		static bool IsKeyTrigger(Keyboard_Keys key, const Keyboard_State* pState, const Keyboard_State* pOldState);

		const Keyboard_State* Keyboard_GetState();

		static bool IsKeyDown(Keyboard_Keys key, const Keyboard_State* pState);
		static bool IsKeyUp(Keyboard_Keys key, const Keyboard_State* pState);
